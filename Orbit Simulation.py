...
def main():
    ...
    #jupiter = Planet('Jupiter', np.array([5.2*AU, 0]), np.array([0, 13060]), 1.89813 * 10**27, orange, 18)
    #saturn = Planet('Saturn', np.array([9.5*AU, 0]), np.array([0, 9670]), 5.683 * 10**26, gold, 18)
    #uranus = Planet('Uranus', np.array([19.8*AU, 0]), np.array([0, 6790]), 8.681 * 10**25, blue, 15)
    #neptune = Planet('Neptune', np.array([30.1*AU, 0]), np.array([0, 5450]), 1.024 * 10**26, dark_blue, 15)
